    ...
    <div className="min-h-screen bg-bg">
      ...
      <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 bg-bg-elevated border-r border-bg-border z-30">
        ...
        <div className="px-3 py-4 border-t border-bg-border space-y-2">
          <Link
            href="/trades/new"
            className="flex items-center justify-center gap-2 w-full py-2.5 bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-400 hover:to-gold-500 text-bg font-semibold rounded-xl transition shadow-md shadow-gold-500/20"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 text-xs text-zinc-500 hover:text-danger hover:bg-danger/10 rounded-lg transition"
          >
